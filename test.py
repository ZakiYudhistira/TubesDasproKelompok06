...
if os.path.exists(save_directory):
    ...
    while program_jalan:
        ...
        if command == "login":
            ...
            data_leaderboard = Module.dataLeaderboard(matriks_user, matriks_candi, matriks_bahan, "jin")
            print("Berikut merupakan leaderboard jin pembuat candi terbanyak:")
            time.sleep(0.5)
            Module.printLeaderboard(data_leaderboard)
        
        elif command == "leaderboardcandi":
            data_leaderboard = Module.dataLeaderboard(matriks_user, matriks_candi, matriks_bahan, "candi")
